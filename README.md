...
### 大変だったこと
- 本番環境(契約しているレンタルWebサーバー)のGLIBCのVerでは、開発環境で使っていたNode.jsのverに対応してないという謎の課題に直面した。それ以外に方法がなさそうだったので、<u> Node.jsのバージョンを`v20.11.1からv18.17.0`に変更 </u>した。プログラムは問題なく動いた。
